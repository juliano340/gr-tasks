  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] flex flex-col" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
        ...
        {/* Blobs decorativos de fundo para manter a identidade */}
        ...
        <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-500">
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-indigo-200/50 border border-gray-100 p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 mt-2 font-medium text-sm">Enviaremos um link de redefinição para o seu e-mail.</p>
            </div>

            {message && (
              <div className={`mb-6 p-4 rounded-xl border-2 animate-in slide-in-from-top-2 duration-300 text-sm font-bold text-center ${
            ...
            <form action={handleSubmit} className="space-y-5">
              ...
              <div className="text-center pt-2">
                <Link href="/login" className="text-xs font-bold text-gray-400 hover:text-indigo-600 transition-colors uppercase tracking-widest underline decoration-1 underline-offset-4">
                  Cancelar e voltar
                </Link>
              </div>
            </form>
